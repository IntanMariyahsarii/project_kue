...
<?php if (mysqli_num_rows($query) > 0) { ?>
    <?php
    while ($data_contact = mysqli_fetch_array($query)) {
    ?>
        <!-- footer#1
============================================= -->
                ...
                <div class="container">
                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                                            <div class="reservation-form mb-30 bg-white text-center">
                                                                <div class="reservation--dec">
                                                                    You can Book a table online easily in just a couple
                                                                    of minutes. We take reservations for lunch and
                                                                    dinner, just check the availability of your table &
                                                                    book it now!
                                                                </div>
                                                                <form class="mb-0">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                                            <div class="form-select">
                                                                                ...
                                                                                <select class="form-control" name="res-day" id="footerDay">
                                                                                    <option value="March 23">March 23,
                                                                                        2017</option>
                                                                                    <option value="March 24">March 24,
                                                                                        2017</option>
                                                                                    <option value="March 25">March 25,
                                                                                        2017</option>
                                                                                    <option value="March 26">March 26,
                                                                                        2017</option>
                                                                                    <option value="March 27">March 27,
                                                                                        2017</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                                                            <div class="form-select">
                                                                                ...
                                                                                <select class="form-control" name="res-time" id="footerTime">
                                                                                    <option value="8:00">8:00 PM
                                                                                    </option>
                                                                                    <option value="9:00">9:00 PM
                                                                                    </option>
                                                                                    <option value="10:00">10:00 PM
                                                                                    </option>
                                                                                    <option value="11:00">11:00 PM
                                                                                    </option>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-4">
                            <div class="footer--widget-content">
                                <h3>Contact us</h3>
                                <p class="mb-0">Main Email: <?= $data_contact["email"] ?></p>
                                <p class="mb-0">Phone: <?= $data_contact["no_telepon"] ?></p>
	...
	============================================= -->
            <div class="footer--copyright text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <span>&copy; 2023 Eternal Cake, With Love by </span> <a href="#">Eternal Cake</a>
                        </div>
                    </div>
                </div>
                <!-- .container end -->
